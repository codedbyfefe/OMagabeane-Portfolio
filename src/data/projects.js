...
const projects = [
  ...
  },
  {
    ...
    tools: "C#, Unity",
    overview:"Sushi Chef is a 2D clicker-style game where players produce sushi and grow their kitchen by purchasing additional chefs. Designed with player comfort in mind, the game uses a single currency, no timers, and a simple, readable UI to create a low-pressure, accessible experience focused on steady progression.",
    problem: "Many clicker and idle-style games overwhelm players with multiple currencies, timers, and complex systems early on, which can create unnecessary pressure and confusion. Instead of feeling rewarding, progression can become stressful, especially for players unfamiliar with the genre. The challenge was to design a clicker game that maintained engagement while prioritising clarity, accessibility, and player comfort, without sacrificing meaningful progression. While also learning and understanding how data management systems work in a game prototype setting.",
    solution:"Sushi Chef addresses this by simplifying the core loop to a single, intuitive interaction: clicking to produce sushi and reinvesting earned currency to increase production through additional chefs. By removing timers and limiting the game to one currency, players can progress at their own pace without pressure. Clear visual sprites and text feedback communicate currency growth, while dedicated instruction and settings screens support first-time players and accessibility needs. The design intentionally focuses on functionality and flow, ensuring mechanics feel understandable and satisfying.",
    process: "The development process began with exploring multiple system designs, including multi-currency and timed mechanics, to evaluate how complexity and pressure would affect the player experience. Player stress and cognitive load were carefully considered when selecting the final approach, leading to a simplified single-currency system without timers. Flowcharts were created to map the main menu, instructions, and core gameplay loop, ensuring a clear and logical flow throughout the game. A minimal user interface was then designed using clear sprites and readable text to communicate interactions and progression effectively. Core mechanics such as click-based currency generation and a chef purchase system were implemented first, with a strong focus on maintaining scope and ensuring the game remained functional, accessible, and easy to understand.",
     screens: [
    "/images/SG2.png",         // main image at the top
    "/images/SG4.png",
    "/images/SG3.png",
  ],
    outcome: "The final prototype delivers a functional, accessible clicker game with a smooth gameplay loop and clear progression. Players can easily understand how to interact with the game, track their progress, and expand their sushi production without feeling rushed or overwhelmed. While some features, such as number-to-word conversions and expanded settings, were deferred for future iterations, the core systems were successfully implemented and provide a solid foundation for further development.",
